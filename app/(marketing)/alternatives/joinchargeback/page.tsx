...
export const metadata: Metadata = {
  title: 'JoinChargeback Alternative: Build Your Evidence Pack for $39',
  description:
    'JoinChargeback is shutting down. ChargebackKit builds a submission-ready chargeback evidence pack — rebuttal narrative, evidence checklist, formatted PDF — in 30 minutes for $39. No subscription. No success fee.',
  alternates: {
  ...
  openGraph: {
    title: 'JoinChargeback Alternative: Build Your Evidence Pack for $39',
    description:
      'JoinChargeback is shutting down. Build a submission-ready chargeback evidence pack in 30 minutes for $39.',
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'ChargebackKit is built around a single deliverable — a submission-ready evidence pack PDF — for a flat $39 per pack. There is no monthly subscription, no per-dispute success fee, and no integration required. You answer a short set of questions about the dispute and download the pack.',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'No account is required to begin building a pack — you can sign up afterward if you want to save your pack reference. The pack is a PDF you upload through your existing processor; ChargebackKit is built for Stripe submission first and the format works for any major processor.',
        },
      },
      {
        '@type': 'Question',
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <h1 className="text-4xl font-bold mb-6 text-gray-900">
          JoinChargeback is shutting down. Build your evidence pack for $39 instead.
        </h1>

        <p className="text-lg text-gray-700 mb-8 leading-relaxed">
          ChargebackKit builds a submission-ready chargeback evidence pack — rebuttal narrative,
          evidence checklist, and a formatted PDF organized around your specific dispute type —
          in about 30 minutes. Flat $39 per pack. No subscription. No success fee.
        </p>
            ...
            <table className="w-full border-collapse border border-gray-300">
              ...
              <tbody>
                ...
                <tr className="bg-gray-50 hover:bg-gray-100">
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-gray-700">Flat $39 per pack</td>
                </tr>
                <tr className="bg-white hover:bg-gray-50">
          ...
          <div className="space-y-6">
            ...
            <div className="border-l-4 border-emerald-500 pl-6 py-3">
              ...
              <p className="text-gray-700">
                ...
                download the pack. Each pack is $39 &mdash; pay only for the disputes you
                actually fight.
              </p>
            </div>
            <div className="border-l-4 border-emerald-500 pl-6 py-3">
        ...
        <section className="bg-brand-50 rounded-lg p-8 text-center">
          ...
          <p className="text-gray-700 mb-6">
            Build a submission-ready chargeback evidence pack in about 30 minutes. Flat $39 per
